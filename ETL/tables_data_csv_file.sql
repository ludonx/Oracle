...
Les donn�es dans les fichiers CSV peuvent contenir plusieurs anomalies � cause de l'h�t�rog�n�it� des sources et des outils utilis�s !
...
-- La colonne Col sera d�compos�e en plusieurs colonnes de m�me type (chaine de caract�res)
